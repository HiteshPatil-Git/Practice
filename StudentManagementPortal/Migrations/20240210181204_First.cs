        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobNumber = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalObtainedMarks = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin@email.com", "aa37ad4a42217e887a6d235faacd7cf1b30ce1e233fb5b3f40989fba008ba150pecT1c", "admin", "Admin", "Active" });

            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "Level" },
                values: new object[] { 1, "L1" });
